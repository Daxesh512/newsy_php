...
if ( ! function_exists( 'newsy_register_menu_meta' ) ) {
	...
	function newsy_register_menu_meta( $meta ) {
		...
		$meta['mobile-menu'] = array(
			...
			'file'  => NEWSY_THEME_PATH . 'includes/options/metabox/mobile-menu.php',
		);
...
if ( ! function_exists( 'newsy_register_image_sizes' ) ) {
	...
	function newsy_register_image_sizes( $image_sizes ) {
		...
		// dimension : 0.5
		$image_sizes[ $prefix . '360x180' ]  = array(
			'width'     => 360,
			'height'    => 180,
			'crop'      => true,
			'dimension' => 500,
		);
		$image_sizes[ $prefix . '750x375' ]  = array(
			'width'     => 750,
			'height'    => 375,
			'crop'      => true,
			'dimension' => 500,
		);
		$image_sizes[ $prefix . '1140x570' ] = array(
			'width'     => 1140,
			'height'    => 570,
			'crop'      => true,
			'dimension' => 500,
		...
		// dimension : 0.715
		$image_sizes[ $prefix . '120x86' ]  = array(
			'width'     => 120,
			'height'    => 86,
			'crop'      => true,
			'dimension' => 715,
		);
		$image_sizes[ $prefix . '350x250' ] = array(
			'width'     => 350,
			'height'    => 250,
			'crop'      => true,
			'dimension' => 715,
		);
		$image_sizes[ $prefix . '750x536' ] = array(
			'width'     => 750,
			'height'    => 536,
			'crop'      => true,
			'dimension' => 715,
		...
		// dimension 1
		$image_sizes[ $prefix . '75x75' ]   = array(
			'width'     => 75,
			'height'    => 75,
			'crop'      => true,
			'dimension' => 1000,
		);
		$image_sizes[ $prefix . '300x250' ] = array(
			'width'     => 300,
			'height'    => 250,
			'crop'      => true,
			'dimension' => 1000,
		...
		// dimension 1.4
		$image_sizes[ $prefix . '360x504' ] = array(
			'width'     => 360,
			'height'    => 504,
			'crop'      => true,
			'dimension' => 1400,
		...
		// featured post
		$image_sizes[ $prefix . '750x0' ]  = array(
			'width'     => 750,
			'height'    => 0,
			'crop'      => true,
			'dimension' => 1000,
		);
		$image_sizes[ $prefix . '1140x0' ] = array(
			'width'     => 1140,
			'height'    => 0,
			'crop'      => true,
			'dimension' => 1000,
...
if ( ! function_exists( 'newsy_register_translation_fields' ) ) {
	...
	function newsy_register_translation_fields( $fields ) {
		$fields['newsy'] = array(
			'name' => esc_html__( 'Newsy Theme Translation', 'newsy' ),
...
if ( ! function_exists( 'newsy_register_theme_ajax' ) ) {
	...
	function newsy_register_theme_ajax( $action ) {
		switch ( $action ) {
			...
			case 'ajax_post_voting':
				Newsy\Ajax\PostAjax::handle_voting();
				break;
