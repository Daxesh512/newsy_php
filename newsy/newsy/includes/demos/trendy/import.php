...
$demo['post'] = array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-animals%%,%%ak-list%%,%%ak-amazing%%',
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-entertainment%%,%%ak-funny%%,%%ak-amazing%%',
		),
		'post_format'       => 'post',
	),
	array(
	...
	array(
		'the_ID'            => 'ak-front-page-2',
		'post_title'        => 'Front page 2',
		'post_content_file' => $demo_path . 'pages/front-page-2.txt',
		'post_type'         => 'page',
		'prepare_vc_css'    => true,
		'force_import'      => true,
		'post_meta'         => array(
