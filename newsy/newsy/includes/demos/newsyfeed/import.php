...
$demo['media'] = array(
	...
	array(
		...
		'file'   => $demo_import_url . 'astrology.png',
	),
	array(
	...
	array(
		'the_ID'       => 'ak-media-hot-bg',
		'file'         => $demo_import_url . 'hot-bg.png',
		'force_import' => true,
	),
	array(
	...
	array(
		'the_ID'       => 'ak-media-newsletter-pattern',
		'file'         => $demo_import_url . 'newsletter-pattern.png',
		'force_import' => true,
	),
);
...
$demo['post'] = array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-list%%,%%ak-entertainment%%,%%ak-quiz%%',
		),
		'post_meta'         => array(
			array(
				'key'   => 'post_primary_category',
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-list%%,%%ak-entertainment%%',
		),
		'post_format'       => 'post',
	),
	array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-entertainment%%,%%ak-quiz%%',
		),
		'post_meta'         => array(
			array(
				'key'   => 'post_primary_category',
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-entertainment%%,%%ak-list%%,%%ak-featured%%',
		),
		'post_meta'         => array(
			array(
				'key'   => 'post_primary_category',
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-funny%%,%%ak-entertainment%%,%%ak-featured%%',
		),
		'post_meta'         => array(
			array(
				'key'   => 'post_primary_category',
