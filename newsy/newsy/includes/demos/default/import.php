...
$demo['plugin'] = array( 'js_composer', 'buzzeditor', 'newsy-elements', 'newsy-social-share', 'newsy-reaction', 'newsy-social-counter', 'newsy-view-counter', 'newsy-voting' );
...
$demo['media'] = array(
	...
	array(
		...
		'file'   => $demo_import_url . 'reactions/angry.gif',
	),
	array(
		'the_ID' => 'ak-media-reaction-awesome',
		'file'   => $demo_import_url . 'reactions/awesome.gif',
	),
	array(
		'the_ID' => 'ak-media-reaction-cry',
		'file'   => $demo_import_url . 'reactions/cry.gif',
	),
	array(
		'the_ID' => 'ak-media-reaction-fail',
		'file'   => $demo_import_url . 'reactions/fail.gif',
	),
	array(
		'the_ID' => 'ak-media-reaction-funny',
		'file'   => $demo_import_url . 'reactions/funny.gif',
	),
	array(
		'the_ID' => 'ak-media-reaction-lol',
		'file'   => $demo_import_url . 'reactions/lol.gif',
	),
	array(
		'the_ID' => 'ak-media-reaction-loved',
		'file'   => $demo_import_url . 'reactions/loved.gif',
	),
	array(
		'the_ID' => 'ak-media-reaction-nice',
		'file'   => $demo_import_url . 'reactions/nice.png',
	),
	array(
		'the_ID' => 'ak-media-reaction-wow',
		'file'   => $demo_import_url . 'reactions/wow.gif',
	),

	// extra
	array(
		'the_ID' => 'ak-media-featured-logo',
		'file'   => $demo_import_url . 'featured.png',
	),
	array(
		'the_ID' => 'ak-media-newsylists-logo',
		'file'   => $demo_import_url . 'newsylists.png',
	),
	array(
		'the_ID' => 'ak-media-newsynews-logo',
		'file'   => $demo_import_url . 'newsynews.png',
	),
	array(
		'the_ID' => 'ak-media-newsyquizzes-logo',
		'file'   => $demo_import_url . 'newsyquizzes.png',
	),
	array(
		'the_ID' => 'ak-media-newsyvideos-logo',
		'file'   => $demo_import_url . 'newsyvideos.png',
	),
	array(
		'the_ID' => 'ak-media-animals-bg',
		'file'   => $demo_import_url . 'animals-bg.png',
	),
	array(
...
$demo['taxonomy'] = array(
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_badge_icon',
				'value' => '%attachment_url%ak-media-featured-logo%attachment_url%',
			),
		),
	),
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				...
				'value' => '%attachment_url%ak-media-newsynews-logo%attachment_url%',
			),
		),
	),
	array(
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_header_bg_color',
				'value' => '#8224e3',
			),
			array(
				'key'   => 'term_header_bg_image',
				'value' => array(
					'img'  => '%attachment_url%ak-media-animals-bg%attachment_url%',
					'type' => 'bottom-center',
				),
			),
			array(
				'key'   => 'term_header_padding_top',
				'value' => '50',
			),
			array(
				'key'   => 'term_header_padding_bottom',
				'value' => '100',
			),
			array(
				'key'   => 'term_grid',
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-media-newsyquizzes-logo%attachment_url%',
			),
			array(
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-media-newsylists-logo%attachment_url%',
			),
			array(
				'key'   => 'term_custom_term_name',
				'value' => 'Viral List & Galleries',
			),
		),
	),
	array(
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_badge_icon',
				'value' => '%attachment_url%ak-media-reaction-awesome%attachment_url%',
			),
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-media-reaction-awesome%attachment_url%',
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_badge_icon',
				'value' => '%attachment_url%ak-media-reaction-nice%attachment_url%',
			),
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-media-reaction-nice%attachment_url%',
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_badge_icon',
				'value' => '%attachment_url%ak-media-reaction-lol%attachment_url%',
			),
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-media-reaction-lol%attachment_url%',
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_badge_icon',
				'value' => '%attachment_url%ak-media-reaction-funny%attachment_url%',
			),
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-media-reaction-funny%attachment_url%',
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_badge_icon',
				'value' => '%attachment_url%ak-media-reaction-fail%attachment_url%',
			),
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-media-reaction-fail%attachment_url%',
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_badge_icon',
				'value' => '%attachment_url%ak-media-reaction-wow%attachment_url%',
			),
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-media-reaction-wow%attachment_url%',
	...
	array(
		...
		'taxonomy_meta' => array(
			...
			array(
				'key'   => 'term_badge_icon',
				'value' => '%attachment_url%ak-media-reaction-cry%attachment_url%',
			),
			array(
				'key'   => 'term_header_custom_logo',
				'value' => '%attachment_url%ak-media-reaction-cry%attachment_url%',
...
$demo['post'] = array(
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-funny%%,%%ak-amazing%%,%%ak-featured%%',
		),
		'post_meta'         => array(
			array(
	...
	array(
		...
		'post_excerpt_file' => $demo_path . 'pages/post-excerpt-2.txt',
		'post_content_file' => $demo_path . 'pages/post-content-2.txt',
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-list%%,%%ak-amazing%%,%%ak-quiz%%',
		),
		'post_meta'         => array(
			array(
				'key'   => 'post_primary_category',
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-amazing%%,%%ak-list%%,%%ak-featured%%',
		),
		'post_meta'         => array(
			array(
				'key'   => 'post_primary_category',
	...
	array(
		...
		'post_terms'        => array(
			'category' => '%%ak-list%%',
			'reaction' => '%%ak-reaction-awesome%%,%%ak-reaction-funny%%',
		),
		'post_format'       => 'post',
	),
	// update below
	...
	array(
		'the_ID'            => 'ak-post-56',
		'post_title'        => 'Watch Why Is Everyone Baking Bread?',
		'post_excerpt_file' => $demo_path . 'pages/post-excerpt-1.txt',
		'post_content_file' => $demo_path . 'pages/post-content-1.txt',
...
$demo['menu'] = array(
		...
		'items'         => array(
			...
			array(
				...
				'item_meta' => array(
					...
					array(
						'key'   => 'viral_menu_icon',
						'value' => NEWSY_THEME_URI . '/assets/images/admin/newsy_logo.png',
					),
				),
			),
		),
	...
	array(
		...
		'items'         => array(
			array(
				'item_id'   => '%%ak-reaction-awesome%%',
				'item_type' => 'taxonomy',
				'taxonomy'  => 'category',
				'item_meta' => array(),
			),
			array(
				'item_id'   => '%%ak-reaction-ew%%',
				'item_type' => 'taxonomy',
				'taxonomy'  => 'reaction',
				'item_meta' => array(),
			),
			array(
				'item_id'   => '%%ak-reaction-fail%%',
				'item_type' => 'taxonomy',
				'taxonomy'  => 'reaction',
				'item_meta' => array(),
			),
			array(
				'item_id'   => '%%ak-reaction-funny%%',
				'item_type' => 'taxonomy',
				'taxonomy'  => 'reaction',
				'item_meta' => array(),
			),
			array(
				'item_id'   => '%%ak-reaction-lol%%',
				'item_type' => 'taxonomy',
				'taxonomy'  => 'reaction',
				'item_meta' => array(),
			),
			...
			array(
				'item_id'   => '%%ak-reaction-nice%%',
				'item_type' => 'taxonomy',
				'taxonomy'  => 'reaction',
				'item_meta' => array(),
			),
			array(
				'item_id'   => '%%ak-reaction-omg%%',
				'item_type' => 'taxonomy',
				'taxonomy'  => 'reaction',
				'item_meta' => array(),
			),
