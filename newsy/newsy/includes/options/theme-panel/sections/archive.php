...
$fields   = array_merge( $fields, newsy_get_layout_fields( 'archive', 'other_pages', 'body.archive' ) );
...
if ( ! function_exists( 'is_woocommerce' ) ) {
	...
	$fields = array_merge( $fields, newsy_get_layout_fields( 'woocommerce', 'other_pages', 'body.shop' ) );
}
