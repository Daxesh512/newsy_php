...
$fields[] = array(
	...
	'output'      => array(
		array(
			'type'     => 'css',
			'element'  => array(
				'.ak-post-sticky-wrap .ak-post_sticky-bar.full-width',
				'.ak-post-sticky-wrap .ak-post_sticky-bar.boxed .ak-bar-inner',
			),
			'property' => 'css-editor',
		),
	),
...
$fields[] = array(
	...
	'output'     => array(
		array(
			'type'     => 'css',
			'element'  => '.ak-post-sticky-wrap .ak-post_sticky-bar',
			'property' => 'height',
			'units'    => 'px',
		),
		array(
...
if ( ! defined( 'NEWSY_VOTING_PATH' ) ) {
	...
	$fields[] = array(
		'id'          => 'post_voting_style',
		'type'        => 'visual_select',
		'heading'     => esc_html__( 'Post Voting Style', 'newsy' ),
		'description' => esc_html__( 'Choose which style you prefer for your voting buttons.', 'newsy' ),
		'options'     => array(
			''        => sprintf( esc_html__( 'Style %s', 'newsy' ), '1' ),
			'style-2' => sprintf( esc_html__( 'Style %s', 'newsy' ), '2' ),
		),
		'section'     => 'post',
	);
