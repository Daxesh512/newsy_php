...
class Gutenberg {
	...
	private function init_outputs() {
		...
		$outputs = apply_filters(
			'newsy/gutenberg/css/outputs', array(
				...
				array(
					'type'     => 'css',
					'element'  => '.wp-block.editor-post-title__block .editor-post-title__input',
					'property' => 'typography',
					'value'    => wp_parse_args(
						newsy_get_option(
				...
				array(
					'type'     => 'css',
					'element'  => '.buzzeditor-question-wrapper .wp-block-cover p',
					'property' => 'typography',
	...
	public function load_style() {
		...
		wp_enqueue_style( 'newsy-editor-styles', NEWSY_THEME_URI . '/style-editor.css', false, '1.0', 'all' );
