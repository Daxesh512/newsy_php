...
abstract class ArchiveAbstract extends TemplateAbstract {
	...
	public function render_header() {
		...
		// Term Bg image
		$has_bg_image = in_array( $this->header_style, array( 'style-5', 'style-6', 'style-7', 'style-8', 'style-9', 'style-10' ), true ) ? 'archive-header-has-bg dark' : '';

		echo "<div class=\"ak-archive-header {$this->header_style} {$has_bg_image}\">
                    <div class=\"container\">
                        {$breadcrumb}
